...
const businesses = [
  { icon: "&#9973;", type: "Marinas & Yacht Clubs", questions: ["Do you have any open slips?", "What are your transient rates?", "Do you have fuel on the dock?"] },
  { icon: "&#128674;", type: "Boat Dealers", questions: ["Do you have [model] in stock?", "What financing options do you offer?", "Can I schedule a sea trial?"] },
  { icon: "&#128295;", type: "Marine Service & Repair", questions: ["How much does a bottom paint job cost?", "Can you work on outboards?", "What&apos;s your turnaround time?"] },
  { icon: "&#9875;", type: "Boat Ramp Operators", questions: ["What are your launch fees?", "Is the ramp open right now?", "Do you have trailer parking?"] },
  { icon: "&#127907;", type: "Fishing Charters", questions: ["What&apos;s your availability?", "How many people per trip?", "What fish are running now?"] },
  { icon: "&#127973;", type: "Waterfront Restaurants", questions: ["Do you have dock & dine?", "What are your hours?", "Is there a wait?"] },
  { icon: "&#127957;", type: "Campgrounds & RV Parks", questions: ["Do you have waterfront sites?", "What are your rates?", "Are you pet friendly?"] },
  { icon: "&#127976;", type: "Hotels & Lodges", questions: ["Do you have availability?", "Is there boat parking?", "What&apos;s checkout time?"] },
  { icon: "&#128722;", type: "Ship Stores & Chandleries", questions: ["Do you carry [brand]?", "What are your hours?", "Do you sell bait?"] },
  ...
  { icon: "&#127968;", type: "Real Estate", questions: ["Is this property still available?", "Can I schedule a showing?", "Are there waterfront lots?"] },
];
...
export default function ForBusinessesPage() {
  return (
    <div>
      ...
      <section className="px-4 pt-8">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Get Featured on MarinaSeeker</h2>
              <p className="text-white/90 text-sm md:text-base">
                Priority placement on state and city pages. Photo gallery of slips and amenities, customer message form, and monthly performance report &mdash; $49.95/mo. Cancel anytime.
              </p>
            </div>
      ...
      <section className="py-16 md:py-24 text-center px-4" style={{ background: "#FAF8F5", backgroundImage: "radial-gradient(circle at 30% 70%, rgba(27,58,92,0.06) 0%, transparent 50%)" }}>
        ...
        <p className="text-gray-500 text-lg mt-6 max-w-xl mx-auto leading-relaxed">
          Own a marina, boat dealer, marine service shop, or waterfront business? CLETUS is an AI chat and voice agent for your website and phone. Works for any business, any industry. Less than $1/day.
        </p>
        <div className="flex gap-3 justify-center mt-8 flex-wrap">
          <a href="https://globalaibots.com/signup" target="_blank" rel="noopener noreferrer" className="bg-[#C4924B] hover:bg-[#b5833e] text-white font-bold px-6 py-3 rounded-lg transition shadow-sm">Start Free 14-Day Trial</a>
          <a href="#see-it" className="border-2 border-navy text-navy hover:bg-navy hover:text-white font-bold px-6 py-3 rounded-lg transition">See It In Action</a>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-12 h-12 rounded-full bg-navy text-white font-bold text-xl flex items-center justify-center mx-auto mb-3">{s.step}</div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={p.name} className={`rounded-xl p-6 text-center ${p.highlight ? "bg-navy text-white" : "bg-white border border-gray-200 shadow-sm"}`}>
      ...
      <section id="see-it" className="max-w-3xl mx-auto px-4 py-14">
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-4">
            Visit <a href="https://askcletus.com" target="_blank" rel="noopener noreferrer" className="text-navy font-semibold hover:underline">askcletus.com</a> to try a live demo. That&apos;s exactly what your customers would experience.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 px-4 text-center" style={{ backgroundImage: "radial-gradient(circle at 50% 100%, rgba(27,58,92,0.06) 0%, transparent 50%)" }}>
        ...
        <a href="https://globalaibots.com/signup" target="_blank" rel="noopener noreferrer" className="inline-block bg-[#C4924B] hover:bg-[#b5833e] text-white font-bold px-8 py-3 rounded-lg transition shadow-sm">Start Your Free 14-Day Trial &rarr;</a>
        <p className="text-gray-400 text-xs mt-4">Questions? <a href="mailto:hello@globalaibots.com" className="text-navy hover:underline">hello@globalaibots.com</a></p>
      </section>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-5xl mx-auto rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 p-6 md:p-8 text-white shadow-lg">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h2 className="text-xl md:text-2xl font-bold mb-2 font-[Cabin]">&#11088; Manage a marina? Get Featured.</h2>
              <p className="text-white/90 text-sm md:text-base">
