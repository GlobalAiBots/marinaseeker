...
export const metadata: Metadata = {
  title: "MarinaSeeker | Every Marina in America — 6,600+ Marinas",
  description: "Find marinas across the United States. 6,600+ marinas with GPS coordinates, amenities, slip info, and local details. Free.",
  ...
  openGraph: {
    ...
    description: "6,600+ marinas across the US. GPS coordinates, amenities, slip info.",
    url: "https://marinaseeker.com",
    siteName: "MarinaSeeker",
    type: "website",
  },
  twitter: { card: "summary", title: "MarinaSeeker | Every Marina in America", description: "6,600+ marinas across the US. GPS coordinates, amenities, slip info." },
