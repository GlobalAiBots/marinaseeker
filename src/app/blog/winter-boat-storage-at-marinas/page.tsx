  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
        ...
        <p>
          <strong className="text-[#1A1A1A]">Cost range:</strong> $0 for storage at your own property (assuming you have space and no HOA restrictions). If you need to rent outdoor storage lot space, expect $50 to $150 per month. Shrink-wrap (<a href="https://www.amazon.com/s?k=boat+shrink+wrap&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) or a quality boat cover (<a href="https://www.amazon.com/s?k=heavy+duty+boat+cover&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) runs $300 to $1,000 depending on boat size.
        </p>
        <p>
        ...
        <p>
          No matter where you store your boat, certain winterization steps are non-negotiable. Fog the engine to coat internal components with protective oil. Add fuel stabilizer (<a href="https://www.amazon.com/s?k=marine+fuel+stabilizer&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) to a full tank and run the engine long enough for treated fuel to reach the injectors. Drain all water systems &mdash; engine cooling, freshwater tanks, livewells, and washdowns &mdash; and pump non-toxic antifreeze through lines that can&apos;t be fully drained. Remove the battery and store it on a battery maintainer (<a href="https://www.amazon.com/s?k=marine+battery+maintainer&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) to keep it topped up without overcharging. Clean the interior thoroughly to prevent mold. Skipping any of these steps risks damage that will cost far more than the winterization itself.
        </p>
