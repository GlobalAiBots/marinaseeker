  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
        ...
        <p>
          Most transient slips include access to shore-side restrooms and showers, potable water at the dock, and an electrical hookup. Electrical service is usually 30-amp, with 50-amp available at larger facilities. Carrying a full set of shore power adapters (<a href="https://www.amazon.com/s?k=marine+shore+power+adapter+30a+50a&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) means you can plug into whatever pedestal configuration the next marina happens to have. Some marinas charge a separate fee for power, typically $5 to $15 per night. Other common amenities include Wi-Fi, laundry facilities, pump-out service, and dinghy docks. Upscale marinas may offer pool access, loaner bicycles, and courtesy cars for provisioning runs into town.
        </p>
