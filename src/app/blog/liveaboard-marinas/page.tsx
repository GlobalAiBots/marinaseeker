  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Reliable shore power</strong> &mdash; You need consistent 30 or 50 amp service. Electrical outages are an inconvenience for weekend boaters but a serious problem for someone living aboard. A pure sine wave inverter (<a href="https://www.amazon.com/s?k=pure+sine+wave+inverter&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) paired with a flexible solar panel (<a href="https://www.amazon.com/s?k=marine+flexible+solar+panel&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) gives you a buffer when shore power drops.</li>
          ...
          <li><strong>Mail and package delivery</strong> &mdash; Confirm the marina accepts mail for liveaboard tenants and has a secure location for packages. If your marina&apos;s pump-out is unreliable, some long-term liveaboards switch to a marine composting toilet (<a href="https://www.amazon.com/s?k=marine+composting+toilet&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) to sidestep the issue entirely.</li>
