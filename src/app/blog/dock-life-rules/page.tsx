  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
        ...
        <p>
          The beauty of this rule is that it is reciprocal. Help your neighbors with their lines, and they will show up for yours. That is how dock communities work. Keep a telescoping boat hook (<a href="https://www.amazon.com/s?k=telescoping+boat+hook&tag=babymydog03-20" target="_blank" rel="noopener noreferrer nofollow sponsored" className="text-[#1B3A5C] hover:underline font-semibold">Our Pick on Amazon</a>) handy at your slip for snagging lines that come up short on a windy day &mdash; the regulars will notice you are equipped to help. The boaters who stand on their aft deck watching someone struggle into a slip without offering help are the ones who find themselves docking solo every time, even when half the dock is home.
        </p>
