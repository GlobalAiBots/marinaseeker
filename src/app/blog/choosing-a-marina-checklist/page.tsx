...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "10 Things to Check Before Choosing a Marina" },
  ],
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-gray max-w-none text-[#1A1A1A] leading-relaxed space-y-6">
        ...
        <p>
          Some marinas offer mobile pump-out service where a staff member comes to your slip on a scheduled basis, which is even more convenient. If neither option is available at the marina you are considering, factor in the time and effort to reach the nearest pump-out location.
        </p>
