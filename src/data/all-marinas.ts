import marinasData from "./marinas.json";
...
// Load and type the raw data
export const unified: Marina[] = (marinasData as Record<string, unknown>[]).map((m) => ({
  id: (m.id as string) || "",
  ...
  capacity: (m.capacity as string | null) || null,
