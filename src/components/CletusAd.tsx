...
export default function CletusAd() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #0B1E33 0%, #1B3A5C 60%, #C4924B 100%)",
        opacity: visible ? 1 : 0,
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="bg-[#C4924B] hover:bg-[#b5833e] text-white font-bold text-sm px-6 py-3 rounded-lg transition shadow-lg shadow-black/20"
              >
          ...
          <div className="flex-shrink-0 w-full md:w-auto">
            <div className="space-y-3">
              {[
                ...
                "Works for any industry — marinas, shops, services",
