...
const sitemapLines = categories.map(c => `  <url><loc>https://www.marinaseeker.com/category/${c.slug}</loc><lastmod>2026-04-10</lastmod><changefreq>weekly</changefreq><priority>0.7</priority></url>`);
